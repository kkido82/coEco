...
(function (angular) {
    angular.module('coeco').component('manageItemsList', {
        controller: Controller,
        controllerAs: 'vm',
        templateUrl: '/app/manageItems/manageItems.list.tmpl.html'
    });
    ...
    function Controller(coecoControllerInitializer, coecoDataService, $state, $q, $http) {
        ...
        //        //var promises = [];
        //        //promises.push(a);
        //        //$q.all(promises).then(getDropDownVals());
        //});
        }
