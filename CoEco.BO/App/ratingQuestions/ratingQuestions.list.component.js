...
(function (angular) {
    angular.module('coeco').component('ratingQuestionsList', {
        controller: Controller,
        controllerAs: 'vm',
        templateUrl: '/app/ratingQuestions/ratingQuestions.list.tmpl.html'
    });
    ...
    function Controller(coecoControllerInitializer, coecoDataService, $state, $q, $http) {
        var vm = this;
        vm.permissionName = 'ratingQuestions';
        vm.entityType = 'ratingQuestions';
